...
public class Project {
    ...
    public Project(int projectId, String project_type, String department, String category, String projectTitle,
            String projectStatement, String techStack, String group_members, String faculty_name, String faculty_email,
            String domain, String githubLink, String srsUploadedLink, String videoUploadedLink, String stringTag,
            int marks, String paperlink, User user) {
        this.projectId = projectId;
        this.project_type = project_type;
        this.department = department;
        this.category = category;
    ...
    public String toString() {
        return "Project [projectId=" + projectId + ", project_type=" + project_type + ", department=" + department
                ...
                + ", srsUploadedLink=" + srsUploadedLink + ", videoUploadedLink=" + videoUploadedLink + ", stringTag="
                + stringTag + ", marks=" + marks + ", paperlink=" + paperlink + ", user=" + user + "]";
    }
